...
<main class="main">
        ...
        <div class="form">
            <form class="data-form">
                ...
                <div class="form-button-group">
                    <a href="#" id="submit-button" class="neon-button">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
                    ...
                    <a href="#" id="reset-button" class="neon-button">
                        <span></span>
                        <span></span>
                        <span></span>
                        <span></span>
    ...
    <section class="table-buttons">
        <a href="#" id="clean-table-button" class="neon-button">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
...
<footer class="footer">
    <span>
        &copy;Yaroslav Kulinich aka Yarki 2020
    </span>
</footer>
</body>
</html>