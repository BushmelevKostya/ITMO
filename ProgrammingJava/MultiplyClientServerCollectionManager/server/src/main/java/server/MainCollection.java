...
public class MainCollection extends TreeMap<Integer, Product> {
    ...
    synchronized public static TreeMap<java.lang.Integer, Product> notFoundCollection() {
        System.out.println("Указанный файл не существует, хотите создать новую коллекцию?\nyes/no");
        return initializeCollection();
    }

    synchronized public static TreeMap<java.lang.Integer, Product> isNullCollection(TreeMap<Integer, Product> collection) {
        if (collection == null) {
    ...
    synchronized public static TreeMap<java.lang.Integer, Product> wrongJSON() {
    ...
    synchronized public static TreeMap<java.lang.Integer, Product> initializeCollection() {
