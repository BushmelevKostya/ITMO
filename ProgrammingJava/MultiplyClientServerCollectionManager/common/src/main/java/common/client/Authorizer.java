...
import common.RecipientChunk;
import common.Response;
import common.SenderChunk;
import common.server.database.Connector;
...
public class Authorizer {
	...
	protected void register() throws IOException, NullPointerException {
		String login = null;
		String name = null;
	...
	private String createPassword(String password, char[] passwordArray, String repeatPassword) throws IOException {
		while (true) {
			...
			do {
				...
				else if (repeatPassword.contains(" ")) System.out.println("Пароль не должен включать в себя пробел!");
